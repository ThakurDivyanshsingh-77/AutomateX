...
export const NODE_SCHEMA_REGISTRY = {
  ...
  gmail: {
    ...
    outputs: {
      ...
      count: { type: 'Number', example: 5, description: 'Number of emails found' },
      messages: { type: 'Array', example: [{ id: '18f...', from: 'user@example.com', subject: 'Invoice #101', date: 'Tue, 4 Aug 2026', snippet: 'Preview...' }], description: 'Array of enriched email message objects' },
      'messages.[].from': { type: 'String', example: 'sender@example.com', description: 'Sender address' },
      'messages.[].to': { type: 'String', example: 'receiver@example.com', description: 'Recipient address' },
      'messages.[].subject': { type: 'String', example: 'Monthly Invoice', description: 'Subject line' },
      'messages.[].date': { type: 'String', example: 'Tue, 4 Aug 2026', description: 'Date sent' },
      'messages.[].snippet': { type: 'String', example: 'Preview of email text...', description: 'Email snippet preview' },
      'messages.[].bodyText': { type: 'String', example: 'Plain text email body...', description: 'Plain text email body' },
      'messages.[].bodyHtml': { type: 'String', example: '<p>HTML body</p>', description: 'HTML email body' },
    },
  },
  slack: {
    label: 'Slack Message',
  ...
  pdfGenerator: {
    ...
    icon: 'FileOutput',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Generation status boolean' },
      ...
      base64: { type: 'String', example: 'JVBERi0x...', description: 'Base64-encoded PDF content' },
      downloadUrl: { type: 'String', example: 'data:application/pdf;base64,JVBERi0x...', description: 'Data URL or direct download link' },
      attachment: { type: 'Object', example: '{ filename, content, contentType }', description: 'Gmail-ready attachment object' },
      'attachment.filename': { type: 'String', example: 'invoice_102.pdf', description: 'Gmail attachment filename' },
      'attachment.content': { type: 'String', example: 'JVBERi0x...', description: 'Gmail attachment Base64 content' },
  ...
  geminiStructureProducts: {
    label: 'Gemini → Structure Products',
    icon: 'Sparkles',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Structuring status boolean' },
      count: { type: 'Number', example: 3, description: 'Number of detected products' },
      products: {
        type: 'Array',
        example: [
          {
            ...
            metaDescription: 'High purity Beta-citronellol for fragrance synthesis.',
            h1: 'Beta-citronellol',
            description: 'Naturally occurring monoterpenoid alcohol...',
            faqs: [{ question: 'What is Beta-citronellol?', answer: 'An organic compound.' }],
          },
        ],
        description: 'Array of structured product objects',
      },
      'products.[].name': { type: 'String', example: 'Beta-citronellol', description: 'Product chemical / trade name' },
      'products.[].casNumber': { type: 'String', example: '106-22-9', description: 'CAS Registry number' },
      'products.[].urlSlug': { type: 'String', example: 'beta-citronellol', description: 'Product URL slug' },
      'products.[].titleTag': { type: 'String', example: 'Beta-citronellol Supplier | CAS 106-22-9', description: 'SEO title tag' },
      'products.[].metaDescription': { type: 'String', example: 'High purity...', description: 'Meta description' },
    },
  },
  forEachProduct: {
    ...
    icon: 'Repeat',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Iteration status boolean' },
      totalItems: { type: 'Number', example: 3, description: 'Total number of items in collection' },
      currentIndex: { type: 'Number', example: 0, description: 'Current zero-based item index' },
      currentItem: {
        type: 'Object',
        example: { name: 'Beta-citronellol', casNumber: '106-22-9', urlSlug: 'beta-citronellol' },
        description: 'Current active product item object in iteration',
      },
      'currentItem.name': { type: 'String', example: 'Beta-citronellol', description: 'Current product name' },
      'currentItem.casNumber': { type: 'String', example: '106-22-9', description: 'Current product CAS number' },
      'currentItem.urlSlug': { type: 'String', example: 'beta-citronellol', description: 'Current product URL slug' },
      'currentItem.titleTag': { type: 'String', example: 'SEO Title', description: 'Current product SEO title' },
    },
  },
  websiteCreateProduct: {
    ...
    icon: 'PackagePlus',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Product creation status' },
      connectionId: { type: 'String', example: 'conn_7f82a91c', description: 'Associated website connection ID' },
      summary: {
        type: 'Object',
        example: { total: 3, created: 3, failed: 0, skipped: 0 },
        description: 'Multi-product processing summary counts',
      },
      'summary.total': { type: 'Number', example: 3, description: 'Total products processed' },
      'summary.created': { type: 'Number', example: 3, description: 'Successfully created products' },
      'summary.failed': { type: 'Number', example: 0, description: 'Failed product creations' },
      'summary.skipped': { type: 'Number', example: 0, description: 'Skipped duplicates' },
      results: {
        type: 'Array',
        example: [{ productName: 'Beta-citronellol', status: 'created', externalId: 'prod_106_22_9' }],
        description: 'List of per-product creation results and response IDs',
      },
    },
  },
  websiteCreateTournament: {
    label: 'Website → Create Tournament',
    icon: 'Trophy',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Tournament creation status' },
      tournamentId: { type: 'String', example: 'tourn_64a1b2c3d4e5', description: 'Created tournament unique ID' },
      createdTournament: {
        type: 'Object',
        example: {
        ...
        description: 'Created tournament object response',
      },
      'createdTournament.title': { type: 'String', example: 'AutomateX Test Tournament', description: 'Tournament title' },
      'createdTournament.game': { type: 'String', example: 'Valorant', description: 'Game name' },
      'createdTournament.mode': { type: 'String', example: 'SQUAD', description: 'Game mode' },
      'createdTournament.prizePool': { type: 'Number', example: 10000, description: 'Total prize pool' },
      'createdTournament.slots': { type: 'Number', example: 64, description: 'Total team slots' },
      'createdTournament.date': { type: 'String', example: '2026-08-20', description: 'Tournament date' },
      'createdTournament.time': { type: 'String', example: '18:00', description: 'Tournament time' },
      'createdTournament.map': { type: 'String', example: 'Haven', description: 'Tournament map' },
      summary: {
        type: 'Object',
        example: { total: 1, created: 1, failed: 0, skipped: 0 },
        description: 'Execution summary counts',
      },
      results: {
        type: 'Array',
        example: [{ title: 'AutomateX Test Tournament', status: 'created', tournamentId: 'tourn_64a1b2c3d4e5' }],
        description: 'Per-tournament creation result details',
      },
    },
  },
  geminiStructureTournament: {
    label: 'Gemini → Structure Tournament',
    icon: 'Trophy',
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Structuring status boolean' },
      count: { type: 'Number', example: 1, description: 'Number of detected tournaments' },
      tournament: {
        type: 'Object',
        example: {
          title: 'AutomateX Test Tournament',
        ...
        description: 'Primary structured tournament object',
      },
      tournaments: {
        type: 'Array',
        example: [
        ...
        description: 'Array of structured tournament objects',
      },
      currentTournament: {
        type: 'Object',
        example: { title: 'AutomateX Test Tournament', game: 'Valorant', map: 'Haven' },
        description: 'Active tournament object',
      },
      'tournament.title': { type: 'String', example: 'AutomateX Test Tournament', description: 'Tournament title' },
      'tournament.game': { type: 'String', example: 'Valorant', description: 'Game name' },
      'tournament.mode': { type: 'String', example: 'SQUAD', description: 'Game mode' },
      'tournament.prizePool': { type: 'Number', example: 10000, description: 'Total prize pool' },
      'tournament.slots': { type: 'Number', example: 64, description: 'Total team slots' },
      'tournament.map': { type: 'String', example: 'Haven', description: 'Playing map' },
      'tournament.date': { type: 'String', example: '2026-08-20', description: 'Tournament date' },
      'tournament.time': { type: 'String', example: '18:00', description: 'Tournament time' },
    },
  },
  forEachTournament: {
    ...
    outputs: {
      success: { type: 'Boolean', example: true, description: 'Iteration status boolean' },
      totalItems: { type: 'Number', example: 1, description: 'Total number of tournaments in collection' },
      currentIndex: { type: 'Number', example: 0, description: 'Current zero-based item index' },
      currentTournament: {
        type: 'Object',
        example: { title: 'AutomateX Test Tournament', game: 'Valorant', map: 'Haven', prizePool: 10000 },
        description: 'Current active tournament object in iteration',
      },
      currentItem: {
        type: 'Object',
        example: { title: 'AutomateX Test Tournament', game: 'Valorant', map: 'Haven' },
        description: 'Alias for current tournament item',
      },
      'currentTournament.title': { type: 'String', example: 'AutomateX Test Tournament', description: 'Tournament title' },
      'currentTournament.game': { type: 'String', example: 'Valorant', description: 'Game name' },
      'currentTournament.mode': { type: 'String', example: 'SQUAD', description: 'Game mode' },
      'currentTournament.map': { type: 'String', example: 'Haven', description: 'Playing map' },
      'currentTournament.prizePool': { type: 'Number', example: 10000, description: 'Total prize pool' },
      'currentTournament.slots': { type: 'Number', example: 64, description: 'Team slots' },
      'currentTournament.date': { type: 'String', example: '2026-08-20', description: 'Tournament date' },
      'currentTournament.time': { type: 'String', example: '18:00', description: 'Tournament time' },
    },
  },
  documentExtract: {
    label: 'Document → Extract Content',
