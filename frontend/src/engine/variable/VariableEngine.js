    ...
    outputs: {
      ...
      createdTournament: {
        ...
        example: {
          ...
          prizePool: 10000,
          winnerCount: 3,
          prizeBreakdown: { first: 5000, second: 3000, third: 2000 },
          slots: 60,
          date: '2026-08-20',
          time: '18:00',
          map: "World's Edge",
      ...
      'createdTournament.title': { type: 'String', example: 'Apex Legends Global Series Qualifier', description: 'Tournament title' },
      'createdTournament.game': { type: 'String', example: 'Apex Legends', description: 'Game name' },
      'createdTournament.mode': { type: 'String', example: 'Battle Royale Trios', description: 'Game mode' },
      'createdTournament.prizePool': { type: 'Number', example: 10000, description: 'Total prize pool' },
      'createdTournament.slots': { type: 'Number', example: 60, description: 'Total team slots' },
      ...
      results: {
        type: 'Array',
        example: [{ title: 'Apex Legends Global Series Qualifier', status: 'created', tournamentId: 'tourn_64a1b2c3d4e5' }],
