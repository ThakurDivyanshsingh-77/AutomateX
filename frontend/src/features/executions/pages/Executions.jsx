...
export const Executions = () => {
  ...
  return (
    <div className="p-6 space-y-6 max-w-7xl mx-auto select-none text-slate-100 font-sans">
      {/* Page Title Header */}
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-indigo-400 border border-slate-800 transition-colors flex items-center gap-1.5 text-xs font-semibold disabled:opacity-50"
          >
            <Download className="w-3.5 h-3.5" /> Export Page JSON
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-5 gap-3">
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-2xl font-extrabold text-white font-mono mt-2">
            {statsLoading ? <Loader2 className="w-5 h-5 animate-spin text-slate-500" /> : stats?.totalExecutions || 0}
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-2xl font-extrabold text-emerald-400 font-mono mt-2 flex items-center gap-1">
            {statsLoading ? <Loader2 className="w-5 h-5 animate-spin text-slate-500" /> : `${stats?.successRate || 0}%`}
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-2xl font-extrabold text-emerald-400 font-mono mt-2">
            {statsLoading ? <Loader2 className="w-5 h-5 animate-spin text-slate-500" /> : stats?.successful || 0}
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-2xl font-extrabold text-rose-400 font-mono mt-2">
            {statsLoading ? <Loader2 className="w-5 h-5 animate-spin text-slate-500" /> : stats?.failed || 0}
          </div>
        </div>
        ...
        <div className="p-4 rounded-2xl bg-slate-900 border border-slate-800 flex flex-col justify-between">
          ...
          <div className="text-2xl font-extrabold text-indigo-400 font-mono mt-2 flex items-center gap-1">
            ...
            {statsLoading ? <Loader2 className="w-5 h-5 animate-spin text-slate-500" /> : `${stats?.averageDuration || 0} ms`}
          </div>
        </div>
      </div>
