    ...
    <div className="max-w-2xl mx-auto space-y-6 select-none font-sans">
      ...
      <Card className="space-y-6">
        <div className="flex items-center gap-3 border-b border-slate-800 pb-4">
          ...
          <div>
            <h1 className="text-lg font-bold text-white tracking-tight">Create New Workflow</h1>
            <p className="text-xs text-slate-400">Setup your workflow details and initial draft settings</p>
          </div>
        </div>
