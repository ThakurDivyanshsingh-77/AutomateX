...
export const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col lg:flex-row relative overflow-hidden font-sans selection:bg-brand-500 selection:text-white">
      {/* Ambient background glows */}
      <div className="fixed top-1/4 left-1/4 w-[32rem] h-[32rem] bg-orange-500/5 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="hidden lg:flex flex-col justify-between p-16 flex-[0_0_460px] bg-white border-r border-slate-200 relative z-10 shadow-sm">
        <div className="space-y-12">
          ...
          <ul className="space-y-3.5 pt-2">
            {PERKS.map((perk, i) => (
              <li key={i} className="flex items-center gap-3 text-xs text-slate-700">
                <div className="p-1 rounded-lg bg-orange-50 border border-orange-200 text-brand-600">
