...
export const NODE_TYPES = {
  ...
  GOOGLE_GEMINI_GENERATE_TEXT: 'googleGeminiGenerateText',
  AI: 'ai',
  // Discord
  DISCORD_MESSAGE_RECEIVED: 'discordMessageReceived',
...
export const NODE_REGISTRY = {
  ...
  [NODE_TYPES.WEBSITE_CREATE_TOURNAMENT]: {
    type: 'websiteCreateTournament',
    category: 'INTEGRATIONS / WEBSITE',
    label: 'Website → Create Tournament',
    subtitle: 'Create tournament on connected website via REST API',
    description: 'Create a tournament on the connected website via REST API with dynamic field mapping.',
    icon: Trophy,
    color: 'violet',
  ...
  [NODE_TYPES.GEMINI_STRUCTURE_TOURNAMENT]: {
    type: 'geminiStructureTournament',
    category: 'AI / DOCUMENT PROCESSING',
    label: 'Gemini → Structure Tournament',
    subtitle: 'Extract strict tournament JSON from documents',
  ...
  [NODE_TYPES.FOR_EACH_TOURNAMENT]: {
    type: 'forEachTournament',
    category: 'CONTROL / FLOW',
    label: 'For Each Tournament',
    subtitle: 'Iterate over extracted tournaments',
  ...
  [NODE_TYPES.GEMINI_GENERATE_TEXT]: {
    type: NODE_TYPES.GEMINI_GENERATE_TEXT,
    category: 'AI',
  ...
  discordMessageReceivedTrigger: {
    ...
    id: 'discordMessageReceivedTrigger',
    category: 'Triggers',
    provider: 'Discord',
    label: 'Discord → Message Received',
    description: 'Start a workflow whenever the connected Discord bot receives a message.',
